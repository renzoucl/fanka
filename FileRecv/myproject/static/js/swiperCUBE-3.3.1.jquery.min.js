					...
					cube: {
						setTranslate: function() {
							...
							if(y.wrapper.css({
								...
								if(y.isHorizontal()) e.transform("translate3d(0px, " + (y.width / 2 + y.params.cube.shadowOffset) + "px, " + 0 + "px) rotateX(90deg) rotateZ(0deg) scale(" + y.params.cube.shadowScale + ")");
								else {
									...
									e.transform("scale3d(" + h + ", 1, " + v + ") translate3d(0px, " + (y.height / 2 + w) + "px, " + 0 + "px) rotateX(-90deg)")
								}
							var b = y.isSafari || y.isUiWebView ? -y.size / 2 : 0;
							y.wrapper.transform("translate3d(0px,0," + 0 + "px) rotateX(" + (y.isHorizontal() ? 0 : t) + "deg) rotateY(" + (y.isHorizontal() ? -t : 0) + "deg)")
						},
						setTransition: function(e) {
